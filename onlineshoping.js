...
//     let customer2 = new Customer("Eakachai ", "Nakhon Pathom");
...
// const main = () => {
//     // สร้างข้อมูลลูกค้า
//     let customer1 = new Customer("Perh", " NPRU");
//     let customer2 = new Customer("EK", "Nakhon Pathom");
//     //console.log(customer1);
...
//     const order1 = new Order("11/01/2567", "In process");
//     const order2 = new Order("12/01/2567", "In process");
...
const main = () => {
  // สร้างข้อมูลลูกค้า
  let customer1 = new Customer("Perth", "NPRU");
  let customer2 = new Customer("Ek", "Nakhon Pathom");
  //console.log(customer1);
